...
const sources: BundleScriptConfig = {
  json: [
    ...
    require.resolve('@iconify/json/json/heroicons.json'), // Bootstrap Icons
    require.resolve('@iconify/json/json/solar.json'), // Bootstrap Icons
    require.resolve('@iconify/json/json/carbon.json'), // Bootstrap Icons
    require.resolve('@iconify/json/json/ic.json'), // Bootstrap Icons
    require.resolve('@iconify/json/json/fluent.json'), // Bootstrap Icons
    require.resolve('@iconify/json/json/fluent-mdl2.json'), // Bootstrap Icons
